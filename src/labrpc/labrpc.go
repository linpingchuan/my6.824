...
type Network struct {
	...
	longReordering bool                        // sometimes delay replies a long
...
func (rs *Server) dispatch(req reqMsg) replyMsg {
	...
	if ok {
		...
		log.Fatalf("labrpc.Server.dispatch(): unknown serivce %v in %v.%v; expecting one of %v\n",
...
func (rn *Network) IsServerDead(endname interface{}, servername interface{}, server *Server) bool {
	...
	if rn.enabled[endname] == false || rn.servers[servername] != servername {
		return true
	}
	return false
}
